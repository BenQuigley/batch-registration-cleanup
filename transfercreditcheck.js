...
duplicateCourses.length === 0 ? "<div style='color:navy'>No transfer credit redundancies found." : "<div style='color:#990000'>The student is enrolled for the following courses which their transfer credits make redundant:\n"+duplicateCourses.join();